                    ...
                    <Stack>
                        ...
                        <Row className="company-button-box">
                            <Col className="company-button-col">
                                {/* <button id="btn-custom-primary" type="submit">
                                    <h3>Get in touch</h3>
                                </button>
                                <Form className="email-entry" action="https://formsubmit.co/dylan.viranyi@gmail.com" method="POST">
                                ...
                                {/* <button id="btn-custom-primary" type="submit"><h3>Get in touch</h3></button>
                                <form className="email-entry" action="https://formsubmit.co/your@email.com" method="POST">
